            ...
            <div className="row justify-content-center">
               <div className="col-xl-6 col-lg-8">
                  <div className="section__title text-center mb-40">
                     ...
                     <span className="text-5xl font-medium text-[#F5F4F9] block">Top Courses We Have</span>
                     <p className="text-[#F5F4F9]">Modorem ipsum dolor sit amet, consectetur adipisicing elitsed eius modetempor incididunt ulabore et dolore magna aliqua.</p>
                  </div>
               </div>
            </div>
