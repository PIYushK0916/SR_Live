...
const About = () => {
   return (
      <section className="about-area-five section-pb-140 mt-24 mb-2">
               ...
               <div className="col-lg-6">
                  <div className="about__content-five">
                     <div className="section__title mb-15">
                        ...
                        <h2 className="title text-[#F6F5FF] bold">Our passion is childhood, and we’re in kindergarten</h2>
                     </div>
                     <p className="text-[#F6F5FF]">Groove’s intuitive shared inbox makes it easy for team members to organize, prioritize and.In this episode of the Smashing Pod we’re talking about Web Platform Baseline.</p>
                     <ul className="about__info-list list-wrap">
                        <li className="about__info-list-item">
                           <i className="flaticon-angle-right"></i>
                           <p className=" text-[#F6F5FF]">Quality School Schedule</p>
                        </li>
                        <li className="about__info-list-item">
                           <i className="flaticon-angle-right"></i>
                           <p className=" text-[#F6F5FF]">Indoor/Outdoor Games for Little Kids</p>
                        </li>
                        <li className="about__info-list-item">
                           <i className="flaticon-angle-right"></i>
                           <p className=" text-[#F6F5FF]">Supporting the Child’s Personality</p>
                        </li>
                     </ul>
                     <div className="about__content-bottom">
                        ...
                        <div className="about__contact">
                           <div className="icon">
                              ...
                              <svg width="61" height="57" viewBox="0 0 61 57" fill="#F6F5FF" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <div className=" text-[#F6F5FF]">
                              <Link to="tel:0123456789" className="text-[#F6F5FF] block" >+985 0059 500</Link>
                              <span className="text-[#F6F5FF] block">Call to Questions</span>
                           </div>
                        </div>
                     </div>
                     <div className="shape">
