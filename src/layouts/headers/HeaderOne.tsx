   ...
   return (
      <>
         <header>
            ...
            <div id="sticky-header" style={{ color:"#ffff", margin:'20px'}} className={`tg-header__area rounded-full ${sticky ? "sticky-menu" : ""} navbar-area-set`}>
                           ...
                           <nav className="tgmenu__nav">
                              ...
                              <div className="tgmenu__action">
                                 <ul className="list-wrap">
                                    ...
                                    <li className="header-btn theme_btn rounded-pill login-btn">
                                       <Link className="bg-[#06235B]" to="/login">Log in</Link>
                                    </li>
                                 </ul>
                              </div>
