...
const FooterThree = () => {
   return (
      <footer className="footer__area-four footer__bg" style={{ backgroundImage: `url(/assets/img/bg/h5_footer.jpg)` }}>
         ...
         <div className="footer__top footer__top-two" style={{background:'#06042E'}}>
            <div className="container">
               <div className="row">
                  <div className="col-xl-2 col-lg-4 col-md-6">
                     <div className="footer__widget">
                        <div className="logo mb-35">
                           {/* <h2 className="text-white">SR</h2> */}
                           <Link to="/"><img src="https://srcodinglms.com/assets/images/logo/logo.png" className="w-[50px] h-[50px]" alt="img" /></Link>
                           </div>
